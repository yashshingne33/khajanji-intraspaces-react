...
export default function ContactPage() {
  ...
  return (
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 900px) {
          ...
          .contact-right { min-height: 50vh !important; margin-top: 0 !important; }
          .pad { padding-left: 24px !important; padding-right: 24px !important; }
          .contact-left { padding: 60px 24px 48px !important; }
          .form-card { 
            position: relative !important; 
            top: 0 !important; left: 0 !important; transform: none !important; 
            width: 100% !important; margin-top: -80px !important; 
        ...
        @media (max-width: 480px) {
          .contact-left { padding: 48px 16px 32px !important; }
          .form-card { padding: clamp(16px, 4vw, 32px) !important; }
        }
      `}</style>
      ...
      >
        {/* ── LEFT ─────────────────────────────── */}
        <div className="contact-left" style={{ display:'flex', flexDirection:'column', justifyContent:'center', padding:'80px 48px 80px' }}>
