...
const STEPS = [
  ...
  { title: 'Schematic design',                          desc: 'At Minnaro, our interior designers develop comprehensive Schematic Designs, Furniture Plans, and Ceiling Plans to optimise the use of space in your house, townhouse, or condo. This strong foundation enables us to thoughtfully select the perfect furniture, finishes, and lighting that complement your home\'s layout and style.' },
  ...
  { title: 'Construction coordination and management',  desc: 'Minnaro\'s design experts meticulously review construction bid proposals and detailed shop drawings, facilitating smooth coordination between the general contractor and all involved trades. We ensure every detail is executed exactly as designed. Additionally, our team manages material and furnishing orders—from placement and delivery tracking to overseeing installations—guaranteeing that everything arrives on time and is perfectly installed in your home.' },
...
const EXPLORE = [
  ...
  { name: 'Station house',        img: 'https://images.unsplash.com/photo-1616137422495-1e9e46e2aa77?w=400&h=260&fit=crop' },
    ...
    <>
      ...
      <section style={{ display:'grid', gridTemplateColumns:'1fr 1fr', minHeight:'78vh' }} className="two-col">
        <div className="pad" style={{ display:'flex', flexDirection:'column', justifyContent:'center', padding:'120px 48px 80px' }}>
          <h1 className="fu1" style={{ fontFamily:"'DM Serif Display',serif", fontSize:'clamp(2rem,3.8vw,3.4rem)', fontWeight:400, lineHeight:1.13, letterSpacing:'-0.01em', marginBottom:28, color:'#0a0a0a' }}>
