...
const SERVICES = [
  {
    ...
    body: [
      'Rooted in the heritage of Minnaro\'s product design and driven by a refined, intuitive eye for colour, our interior design team brings a unique, personal touch to every project. We specialise in creating spaces that are not only sophisticated and timeless, but also rich in texture, narrative, and meaning. Drawing inspiration from natural materials, harmonious palettes, and layered details, our award-winning interiors are designed to evoke emotion—each space carefully curated to feel lived-in, loved, and entirely bespoke.',
    ...
    projects: [
      { name: 'Quebec mountain view', img: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=580&fit=crop' },
      { name: 'Station house',        img: 'https://images.unsplash.com/photo-1616137422495-1e9e46e2aa77?w=380&h=260&fit=crop' },
      { name: 'Villa skyfall',        img: 'https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?w=380&h=260&fit=crop' },
    ],
  },
  {
    id: 'lighting-design',
    ...
    projects: [
      { name: 'Hilton forest colonial', img: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=400&h=580&fit=crop' },
      { name: 'The NY apartment',       img: 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=380&h=260&fit=crop' },
      { name: 'Modern fantasy',         img: 'https://images.unsplash.com/photo-1618219944342-824e40a13285?w=380&h=260&fit=crop' },
    ],
  },
  {
    ...
    projects: [
      { name: 'Rolling apartment', img: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=400&h=580&fit=crop' },
      { name: 'French affair',     img: 'https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?w=380&h=260&fit=crop' },
      { name: 'Villa Neron',       img: 'https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?w=380&h=260&fit=crop' },
    ],
  },
  {
    id: 'construction',
    ...
    projects: [
      ...
      { name: 'Welington house', img: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=380&h=260&fit=crop' },
      { name: 'Casa 201',        img: 'https://images.unsplash.com/photo-1613977257363-707ba9348227?w=380&h=260&fit=crop' },
    ],
  },
]
            ...
            <div className="svc-proj-grid">
              {svc.projects.map((p, i) => (
                <div key={i} className={`sr sr-d${i + 1}`}>
                  <div className="iz" style={{ height: i === 0 ? 480 : 240, marginBottom:12 }}>
                    <img
                      src={p.img}
                      alt={p.name}
                      style={{ width:'100%', height:'100%', objectFit:'cover' }}
