...
//             padding: 100px 24px 36px !important;
//             order: 1;
//           }
          
//           /* Hero image container adjustments */
//           .two-colHero > div:last-child {
//             height: 75vh !important; /* Increased height to maximize architectural visibility */
//             order: 2;
//           }
...
//           /* Ensures the building has enough vertical room to show fully */
//           .two-colHero > div:last-child { 
...
//           {/* Right — hero photo */}
//           <div style={{ overflow: 'hidden', height: '100vh', background: 'var(--color-background-primary)' }} className="iz sr sr-d2">
//             <img
//               src="/assets/service-hero.jpg"
//               alt="Interior design"
//               style={{
