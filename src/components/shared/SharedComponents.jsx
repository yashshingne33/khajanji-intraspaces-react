...
//       {/* Full Width Top Header Row — Matches the font and line rhythm */}
//       <div style={{ borderBottom: '1px solid #e4e2dc', paddingBottom: '32px', marginBottom: '40px' }}>
...
//       {/* Balanced Horizontal 3-Column Grid */}
...
export function CommitmentSection({ columns }) {
  return (
    <section style={{ padding: '80px 48px', maxWidth: '1500px', margin: '0 auto' }}>
      {/* Full Width Top Header Row — Centered to match balanced layout */}
      <div style={{ borderBottom: '1px solid #e4e2dc', paddingBottom: '32px', marginBottom: '40px', textAlign: 'center' }}>
        <h2 className="sr" style={{ 
          fontFamily: "'Outfit', sans-serif", 
          fontSize: 'clamp(1.8rem, 3vw, 2.6rem)', 
          fontWeight: 400, 
        ...
        {columns.map((col, i) => (
          <div key={i} className={`sr sr-d${i + 1}`} style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <h3 style={{ 
              ...
              fontSize: 15, 
              fontWeight: 500, 
              marginBottom: 20, // Slightly increased margin to establish a uniform starting line
              color: '#0a0a0a',
              letterSpacing: '0.02em'
            }}>
              {col.title}
            ...
            {/* Bullet Points with exact text line alignment settings */}
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {col.bullets && col.bullets.map((b, j) => (
                <li key={j} style={{ 
                  fontFamily: "'Outfit', sans-serif", 
                  fontSize: 13, 
                  lineHeight: '1.6', // Tightened slightly to ensure multi-line elements look structured
                  color: '#555', 
                  fontWeight: 300, 
                  display: 'flex', 
                  alignItems: 'flex-start', 
                  ...
                  {/* Custom minimalist bullet dot precisely locked to the first line of text */}
                  <span style={{ 
                    marginTop: '7px', 
                    width: 4, 
                    height: 4, 
